...
| POST | `/agentmemory/graph/prune-orphans` |
...
| POST | `/agentmemory/metrics/reset` |
...
| POST | `/agentmemory/reindex-vectors` |
...
| POST | `/agentmemory/session/sweep` |
